...
public class ImageMap {
    ...
    public ImageMap(){
        ...
        try {
	        ...
	        map.put("ramboDOWN", new Image(new File("src/main/java/fr/iut/montreuil/S05_R08/tp01_GestionVersion/ressources/player/ramboDOWN.png").toURI().toURL().toString()));
	        map.put("ramboUP", new Image(new File("src/main/java/fr/iut/montreuil/S05_R08/tp01_GestionVersion/ressources/player/ramboUP.png").toURI().toURL().toString()));
	        map.put("ramboRIGHT", new Image(new File("src/main/java/fr/iut/montreuil/S05_R08/tp01_GestionVersion/ressources/player/ramboRIGHT.png").toURI().toURL().toString()));
	        map.put("ramboLEFT", new Image(new File("src/main/java/fr/iut/montreuil/S05_R08/tp01_GestionVersion/ressources/player/ramboLEFT.png").toURI().toURL().toString()));
