    ...
    public ArrayList<String> addReplique(String nom){
        ...
        switch (nom) {
            ...
            case "moine":
                ...
                break;
            case "spectre":
            	lines.add("Si vous voulez monter de niveau vous devez gagner l'expérience requise, et avoir parcourue au moins 5000 pas depuis le dernire level up ou payer 50$");
